( Introduction ) This is my Custom Key clicker since i got tired of not being able to auto click ANY button so i made my own macro

(tutorial ) alright so basically you go to the 2cd tab and select the thing you want to auto click from the 4 categories then go back to the 1st tab and set how fast you want the auto clicker (ps): |60 ms is not 1 second 1000 ms is one second look it up| after setting your speed then just press F1 then when your done auto clicking press F2 and when you want to close it press F3 or the X button
